...
GRANT SELECT ON hr.departments TO user1; -- SELECT 권한부여
GRANT INSERT ON hr.departments TO user1; -- INSERT 권한부여
...
GRANT RESOURCE, CONNECT, DBA TO user1; -- 관리자 권한 부여

REVOKE RESOURCE, CONNECT, DBA FROM user1; -- 관리자 권한 회수
